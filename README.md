...
[Скачать последнюю версию](https://github.com/OWNER/REPO/releases/latest)
...
1. Закрой игру.
2. Скачай `KnightsEnd_RU_patch.zip` из [Releases](https://github.com/OWNER/REPO/releases/latest).
3. Распакуй содержимое архива в папку игры, где лежит папка `KnightsEnd`.
4. Согласись на замену файлов, если Windows спросит.
5. Запусти игру.

Внутри архива должна быть такая структура:
...
- `docs/RELEASE.md` - инструкция по публикации релиза.
- `docs/STYLE_GUIDE.md` - правила стиля перевода.
